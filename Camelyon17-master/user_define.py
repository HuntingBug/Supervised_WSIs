...
class config():
    ...
    result_path = './result/'
    wrong_path = './pre_dataset/difficult/'
    heatmap_path = './test/heatmap/'

    origin_path  = './pre_dataset/'
    xml_path = './pre_dataset/annotation/'
    slide_path = './pre_dataset/slide/'
    mask_path = './pre_dataset/mask/'
    patch_path = './pre_dataset/patch/'
    dataset_path = './pre_dataset/dataset/'
    mining_csv_path = './pre_dataset/difficult/'

    test_path = './test/'

    #dataset_eval.py
    demo_slide_path = './pre_dataset/t_6.tif'
